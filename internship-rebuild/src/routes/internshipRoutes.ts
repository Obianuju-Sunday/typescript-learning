...
import { createInternship, getAllInternships, getInternshipById, updateInternship, deleteInternship, applyToInternship, getApplicationsForInternships} from "../controllers/internshipController";
